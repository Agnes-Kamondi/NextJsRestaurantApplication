const BestOffers = () => {
    return (
      <div className="container mx-auto px-4 py-8">
        ...
        <p className="text-gray-700 mb-8">The food at your doorstep. Why starve when you have us. You hunger
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="flex items-center bg-white rounded-lg shadow-md p-4">
            ...
            <img 
              ...
              alt="Any day offer" 
              className="rounded-full w-56 h-56 object-cover" // Set width to w-56
            />
          </div>
