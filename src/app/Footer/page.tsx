const Footer = () => {
    return (
      <>
        <footer className="bg-gray-800 text-white py-8 px-4 flex flex-col sm:flex-row gap-96
        ">
          <div className="flex flex-col space-y-4">
            <h3 className="text-xl font-bold">FoodHouse.</h3>
            <p className="text-sm">
              Best cooks and best delivery guys all at your service.<br/> Hot tasty food
        ...
        <div className="bg-yellow-300 text-gray-800 py-4 flex items-center gap-32">
          <div className="text-sm">Copyright 2021 Besnik. All Rights Reserved.</div>
          <div className="flex space-x-4">
            <a href="/terms" className="hover:text-gray-600 cursor-pointer">Terms</a>
            <a href="/privacy" className="hover:text-gray-600 cursor-pointer">Privacy</a>
            <a href="/security" className="hover:text-gray-600 cursor-pointer">Security</a>
          </div>
        </div>
      </>
    );
